...
layers configuration. You are free to put any user code."
  ...
  (set-face-attribute 'default nil :font "Source Code Pro T4c-17")

  ;; Enable elpy layer
  ;; (setq-default dotspacemacs-configuration-layers '(elpy))

  ;; Enable vim style commenting.
  (setq-default dotspacemacs-configuration-layers '(evil-nerd-commente))
  ...
  ;; Keybindings to emulate iterm tab and split navigation.
  ...
  ;; Keybinding to make cmd + RET send code in region or on current line.
  (defun send-python-to-repl ()
    (if (use-region-p)
        (python-shell-send-region (region-beginning) (region-end))
      (python-shell-send-defun nil)))
  (global-set-key (kbd "s-<return>")  (lambda () (interactive) (send-python-to-repl)))
)
